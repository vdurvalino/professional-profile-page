...
export const en: LocaleSchema = {
    ...
    features: ["Interactive portfolio with my projects", "Blog about development and AI automation", "Link aggregator and useful resources"],
    workingOn: "Working with:",
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "n8n", "AI Automation",],
    contact: "Let's talk?",
    email: "Get in touch",
