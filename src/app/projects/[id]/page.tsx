    ...
    <div className="container mx-auto px-6 py-16">
      ...
      <div className="grid md:grid-cols-5 gap-12">
        ...
        <div className="md:col-span-2">
          <div className="bg-gray-100 dark:bg-gray-800/50 p-8 rounded-lg">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {project.tech.map((tech, i) => (
                <span
                  key={i}
                  className="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded-full text-sm font-mono"
                >
                  {tech}
                </span>
              ))}
